...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    private function doMatch(string $rawPathinfo, array &$allow = array(), array &$allowSchemes = array()): ?array
    {
        ...
        switch ($pathinfo) {
            default:
                $routes = array(
                    '/blog' => array(array('_route' => 'blog', '_controller' => 'App\\Controller\\BlogController::list'), null, null, null),
                    '/hello/world' => array(array('_route' => 'hello_world', '_controller' => 'App\\Controller\\HelloWorldController::index'), null, null, null),
        ...
        foreach ($regexList as $offset => $regex) {
            while (preg_match($regex, $matchedPathinfo, $matches)) {
                switch ($m = (int) $matches['MARK']) {
                    default:
                        $routes = array(
                            21 => array(array('_route' => 'blog_show', '_controller' => 'App\\Controller\\BlogController::show'), array('slug'), null, null),
